...
export interface MemoryStore {
  upsert(item: Omit<MemoryItem, "id" | "createdAt" | "updatedAt"> & { id?: string }): Promise<MemoryItem>
  get(id: string): Promise<MemoryItem | null>
  list(opts?: { tier?: MemoryTier; tags?: MemoryTag[]; limit?: number; offset?: number }): Promise<MemoryItem[]>
