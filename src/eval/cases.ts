...

  {
    ...
    history: [
      { role: 'user', surface: 'discord', text: 'yo did you see that pr i pushed' },
      {
        role: 'assistant',
        surface: 'discord',
        text: 'Saw it, looks clean. Left you one comment on the error handling, rest is good to merge.',
      },
    ],
    expect: {
    ...
    history: [
      {
        role: 'user',
        surface: 'dashboard',
        text: 'can you help me think through the wedding budget spreadsheet',
      },
      {
        role: 'assistant',
        surface: 'dashboard',
        text: "Sure. The venue line is the one to watch, everything else is small money. Send the sheet and I'll poke holes in it.",
      },
    ],
    expect: {
  ...
  },
  {
    ...
    history: [
      ...
      { role: 'user', surface: 'discord', text: 'after work' },
      {
        role: 'assistant',
        surface: 'discord',
        text: "That's the one. Give it two weeks before you judge it.",
      },
    ],
    expect: {
